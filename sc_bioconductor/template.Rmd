...
sce <- DropletUtils::read10xCounts(samples = "/project/obds/shared/resources/4_r_single_cell/singlecell_bioconductor/filtered_feature_bc_matrix/",
                                   sample.names = "pbmc5k")
...
#mean = mean count across cells
#detected = percentage of cells in dataset with non-zero counts
...
ggplot(as_tibble(dec), aes(mean, bio)) +
